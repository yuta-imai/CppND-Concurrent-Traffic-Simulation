...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    if(_trafficLight.getCurrentPhase() == TrafficLightPhase::red) {
        std::cout << "Vehicle #" << vehicle->getID() << " is waiting for signal to turn green at intersection #" << _id << std::endl;
        _trafficLight.waitForGreen();
    }
    std::cout << "Vehicle #" << vehicle->getID() << " is entering intersection #" << _id << std::endl;
